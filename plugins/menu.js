...
╰──────────━⃝┅⃝━────────┘`*/
 ...
 let mode = global.opts['self'] ? 'Private' : 'Publik'
  ...
  let fgif = {
    ...
    //-------------------- HYDRATED
    /*conn.sendHydrated(m.chat, text.trim(), wm, 'https://telegra.ph/file/a46ab7fa39338b1f54d5a.mp4', 'https://chat.whatsapp.com/FIM3MYBxvioJ8NtlJcTUoT', 'GROUP ALLBOTZ🔎', '6281365255567', '👤OWNER👤', [
      ['👉DONASI👈', '/donasi'],
      ['🤖SPEED BOT💻', '/ping'],
      ['🤔SCRIPT🔎', '/script']
    ], m)*/
